...
extern int active_win_idx, z_order[MAX_WINDOWS], app_owner_win_id, gui_cursor_mode, app_running, app_task_id, network_task_id;
...
void release_app_owner_command_state(void);
...
uint32_t crc32_bytes(const unsigned char *buf, uint32_t len);
